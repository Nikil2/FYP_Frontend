...
export const WORKERS_DETAIL_DATA: Record<string, WorkerDetail> = {
  ...
  // Worker 6: Imran Malik - Electrician
  "imran-malik": {
    id: "imran-malik",
    name: "Imran Malik",
    category: "Electrician",
...
// Export function to get worker by ID
export function getWorkerDetail(workerId: string): WorkerDetail | null {
  return WORKERS_DETAIL_DATA[workerId] || null;
}

// Export all workers array for listing
export const ALL_WORKERS: WorkerDetail[] = Object.values(WORKERS_DETAIL_DATA);
